...
public class QT_Tool_Lumberaxe extends GT_Tool_Axe implements IAOE_Tool {
...
//                    PlayerUtils.sendChatMessage(player, "Well, that's embarrassing, you missed!");
	...
	public static class TreeChopTask {
		...
		public final QT_Tool_Lumberaxe axe;
		...
		public TreeChopTask(QT_Tool_Lumberaxe axe, ItemStack stack, ChunkPosition start, EntityPlayer player, int blocksPerTick) {
